...
faq:
  - q: "Did radar detect the Pearl Harbor attack before it happened?"
    a: "Yes. At 7:02 AM on December 7, 1941, Privates George Elliott and Joseph Lockard tracked a large formation 137 miles out on the SCR-270 radar at Opana Point, 43 minutes before the first bombs fell."
  - q: "Why was the Pearl Harbor radar warning ignored?"
    a: "The SCR-270 gave only bearing and range, with no altitude and no aircraft count. Lieutenant Kermit Tyler, on his second day at the Information Center, reasonably concluded the contact was a flight of B-17s expected from California that morning."
  - q: "Why did General Marshall's warning arrive after the attack?"
    a: "Marshall declined the Navy's high-powered radio and routed the message through congested Army channels. It went via a commercial RCA cable office in Honolulu with no priority marking and was stamped received at 11:45 AM, four hours after the first torpedo hit."
  - q: "How did Japanese torpedoes work in Pearl Harbor's shallow water?"
    a: "Lieutenant Commander Haruo Hirota fitted the Type 91 with small gyroscopic ailerons carrying breakaway wooden sleeves. These held the weapon upright through the drop and shattered on impact, letting it level off in under 40 feet of water instead of burying itself in the mud."
  - q: "Was Pearl Harbor caused by American negligence?"
    a: "No. Three independent systems failed at once: a radar that could not identify what it saw, an intelligence warning that arrived late, and a torpedo that defeated the harbor's depth assumption. Repair any one of them and the outcome changes."
---
...
He was not guessing randomly. He was reasoning from the only information the radar gave him. Britain had already solved this exact problem: [the Dowding System existed to turn raw radar contacts into filtered, identified tracks](/blog/battle-of-britain-hitlers-ego), and Oahu had no equivalent. An unknown, large formation approaching from the north. No altitude. No count. No identification. Given those inputs, "it's the B-17s" was a logical conclusion. The limitation wasn't Tyler's intelligence. It was the instrument.
