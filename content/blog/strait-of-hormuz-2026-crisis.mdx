...
faq:
  - q: "How much oil passes through the Strait of Hormuz?"
    a: "Around 20 million barrels a day in 2025, roughly 20 percent of global petroleum consumption and about 25 percent of all seaborne oil trade, moving through two shipping lanes each two miles wide."
  - q: "Is there a way to bypass the Strait of Hormuz?"
    a: "Only partially. Saudi Arabia's East-West Petroline has a theoretical maximum near 5 million barrels per day, about a third of normal Hormuz flow, and roughly 2 million of that was already in use. Qatar and the UAE have no pipeline alternative for LNG at all."
  - q: "How did Iran close the Strait without sinking ships?"
    a: "Through layered interdiction: sea mines in the navigable lanes, coastal anti-ship missile batteries and fast-attack boarding units. On March 5, seven of twelve major marine insurance syndicates cancelled war-risk cover for the Gulf, which stopped commercial shipping before the IRGC had to."
  - q: "Why does the Hormuz closure threaten the global food supply?"
    a: "The Gulf manufactures a large share of the world's nitrogen fertilizer using cheap natural gas. Between 20 and 30 percent of global fertilizer is now stranded there, and crops across the Global South run on rigid application windows that cannot be made up after the season passes."
  - q: "Who is still shipping through the Strait of Hormuz?"
    a: "Of 187 transits since March 4, over half are operated from four countries, with Chinese-flagged and Chinese-operated vessels the majority, moving under a Beijing-Tehran arrangement. Japanese, South Korean and European tankers remain blocked by cancelled war-risk insurance."
---
...
| Country | LNG Exported Through Hormuz | Pipeline Bypass |
|---|---|---|
| Qatar | 93% | None |
| UAE | 96% | None |
| Saudi Arabia | Partial (crude) | East-West Petroline |
| Kuwait | ~100% | None |
| Iraq | ~100% | None |
...
<BarChart
  title="Oil Bypass Capacity vs. Hormuz Throughput"
  subtitle="Maximum theoretical throughput by route — millions of barrels per day"
  unit="M bpd"
  items={[
    { label: "Strait of Hormuz (normal flow)", value: 20, highlight: true },
    { label: "East-West Petroline (maximum capacity)", value: 5 },
    { label: "East-West Petroline (active pre-crisis)", value: 2 }
  ]}
/>
...
<BarChart
  title="Daily Commercial Transits — Before and After the Blockade"
  subtitle="Average transits per day through the Strait of Hormuz"
  unit="/day"
  items={[
    { label: "Pre-crisis average (before Feb 28)", value: 138, highlight: true },
    { label: "Post-blockade average (Mar 4 – May 2026)", value: 3, displayValue: "~3" }
  ]}
/>
...
| Operator | Transit Status | Reason |
|---|---|---|
| China | Moving | Beijing-Tehran bilateral agreement |
| Russia | Moving (limited) | Informal IRGC transit fees |
| Japan | Blocked | War-risk insurance cancelled |
| South Korea | Blocked | War-risk insurance cancelled |
| Europe | Blocked | War-risk insurance cancelled |
| USA | Blocked | Naval standoff, sanctions |
...
<BarChart
  title="UAE Oil Production — Capacity vs. OPEC Constraint"
  subtitle="Millions of barrels per day"
  unit="M bpd"
  items={[
    { label: "UAE production capacity (2026)", value: 4.8, highlight: true },
    { label: "UAE 2027 production target", value: 5 },
    { label: "Estimated OPEC quota (pre-exit)", value: 3.2 }
  ]}
/>
