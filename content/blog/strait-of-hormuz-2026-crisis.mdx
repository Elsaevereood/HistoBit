...
<Timeline items={[
  { time: "Feb 28", event: "Strait averaging 138 commercial transits per day before the crisis begins" },
  { time: "Mar 4", event: "IRGC blockade takes effect; commercial transits collapse to near zero" },
  { time: "Mar 5", event: "Seven of twelve major global marine insurance syndicates cancel war-risk coverage across the Persian Gulf" },
  { time: "Mar 20", event: "Iraq declares force majeure on all foreign-operated oilfields as domestic storage hits saturation" },
  { time: "Apr 18", event: "Ceasefire opens the Strait for 24 hours; 150 vessels begin moving before the IRGC closes it again" },
  { time: "Apr 28", event: "UAE announces withdrawal from OPEC and OPEC+, effective May 1, ending 59 years of membership" }
]} />
